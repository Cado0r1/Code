...
function GetMoves(piece) {
  switch (piece) {
    // White pieces
    case 'P':
      return Move.WhitePawnMoves(WhitePawns, BlackPieces(), NumberToChessNotation[formerselected]);
    case 'R':
      return Move.RookMoves(WhiteRooks, BlackPieces(), NumberToChessNotation[formerselected]);
    case 'Q':
      return Move.QueenMoves(WhiteQueen, BlackPieces(), NumberToChessNotation[formerselected]);
    case 'B':
      return Move.BishopMoves(WhiteBishops, BlackPieces(), NumberToChessNotation[formerselected]);
    case 'N':
      return Move.KnightMoves(WhiteKnights, BlackPieces(), NumberToChessNotation[formerselected]);
    case 'K':
      return Move.KingMoves(WhiteKing, BlackPieces(), NumberToChessNotation[formerselected]);

    // Black pieces
    case 'p':
      return Move.BlackPawnMoves(BlackPawns, WhitePieces(), NumberToChessNotation[formerselected]);
    case 'r':
      return Move.RookMoves(BlackRooks, WhitePieces(), NumberToChessNotation[formerselected]);
    case 'q':
      return Move.QueenMoves(BlackQueen, WhitePieces(), NumberToChessNotation[formerselected]);
    case 'b':
      return Move.BishopMoves(BlackBishops, WhitePieces(), NumberToChessNotation[formerselected]);
    case 'n':
      return Move.KnightMoves(BlackKnights, WhitePieces(), NumberToChessNotation[formerselected]);
    case 'k':
      return Move.KingMoves(BlackKing, WhitePieces(), NumberToChessNotation[formerselected]);
...
function ChooseBitboardUpdate(piece) {
  switch (piece) {
    // White pieces
    case 'P':
